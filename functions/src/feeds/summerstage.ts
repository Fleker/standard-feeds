...
export default {
  obtainFeed: async () => {
    ...
    const res = await fetch.default("https://cityparksfoundation.org/wp-admin/admin-ajax.php?action=get_events&date=20220511&filters%5B0%5D%5Bname%5D=Search%3A+Category+-+summerstage&filters%5B0%5D%5Bterm%5D=Category+-+summerstage&filters%5B0%5D%5Bactive%5D=true&filters%5B0%5D%5Btype%5D=search&days=31&preciseDate=false");
